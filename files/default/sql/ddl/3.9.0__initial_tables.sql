...
CREATE TABLE `feature_group` (
                                ...
                                CONSTRAINT `connector_fk` FOREIGN KEY (`connector_id`) REFERENCES `feature_store_connector` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
CREATE TABLE `schemas` (
                           `id` int(11) NOT NULL AUTO_INCREMENT,
                           `schema` text COLLATE latin1_general_cs NOT NULL,
                           `project_id` int(11) NOT NULL,
                           PRIMARY KEY (`id`)
) ENGINE=ndbcluster DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
--
